...
Q = ext.solve_compound_rec(rec.recurrence_step_two_switch, pVec, pStd, N, 400, \
    distribution='gamma', precision=60)
fig = plt.figure()
...
Q = ext.solve_compound_rec(rec.recurrence_step_three_switch, prms, kstd, N, \
    M=391, parIdx=8,  distribution='lognormal', precision=73)
...
Q = ext.solve_compound(an.analytic_twotwo, prms, kstd, N, parIdx=6, \
